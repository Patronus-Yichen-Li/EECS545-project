...
class HIST(nn.Module):
    ...
    def forward(self, x, concept_matrix, market_value):
        ...
        concept_to_stock = global_func.cal_cos_similarity(x_hidden, hidden)
        ...
        h_stock_to_concept = global_func.cal_cos_similarity(h_shared_info, hidden)
        ...
        h_concept_to_stock = global_func.cal_cos_similarity(h_shared_info, hidden)
