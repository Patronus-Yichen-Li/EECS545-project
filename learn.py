...
Modification:
    V1.0: Implement basic data process, simple testing script
    V2.0: Added training and testing functions
"""
...
if __name__ == "__main__":
    ...
    data_matrix_valid = data_matrix[0:end_valid]  # generate validation data set
    data_matrix_test = data_matrix[0:end_test]  # generate test data set
    ...
    for times in range(20):
        ...
        for epoch in range(3):
            ...
            train_loss, train_score, train_precision, train_recall, train_ic, train_rank_ic = test_epoch(epoch, model,
                                                                                                         ...
                                                                                                         marketValue,
                                                                                                         prefix='Train')
            val_loss, val_score, val_precision, val_recall, val_ic, val_rank_ic = test_epoch(epoch, model,
                                                                                             data_matrix_valid,
                                                                                             stock2concept, marketValue,
                                                                                             prefix='Valid')
            ...
            print('train_rank_ic %.6f, valid_rank_ic %.6f, test_rank_ic %.6f' % (
