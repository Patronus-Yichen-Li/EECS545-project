...
class OptHIST():
    ...
    def __init__(self, input_size=6, hidden_size=64, num_layers=2, dropout=0.0, K=3):
        ...
        :param hidden_size: # of features encoded after LSTM
        :param num_layers: for LSTM
        :param dropout: for LSTM
    ...
    def encode_feature(self, x):
        ...
        :return: LSTM-extracted feature X0
        """
    ...
    def predefined_concept(self, x0, concept_matrix: torch.tensor, market_value: torch.tensor):
        ...
        :param x0: encoded feature after LSTM (num_stocks * hidden_size)
    ...
    def individual_concept(self, x2):
        ...
        :return: forecast output output_individual
        """
