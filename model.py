...
class OptHIST(nn.Module):
    ...
    def predefined_concept_novelty(self, x0, concept_matrix: torch.tensor, stock_index):
    ...
    def forward(self,x,concept_matrix:torch.tensor, stock_index: torch.tensor, market_value:torch.tensor):
        ...
        '''predefined_concept'''
        self.predefined_concept_novelty(x0,concept_matrix, stock_index) #change here if use different predefined module
